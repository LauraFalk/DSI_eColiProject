...
'param_1', 'param2']
pdd = pd.DataFrame(Test_and_train_opt_loop_metric, columns=col_names).to_excel('Test_and_train_opt_loop_metric_LR_LMP_236.xlsx')
os.startfile('Test_and_train_opt_loop_metric_LR_LMP_236.xlsx')
