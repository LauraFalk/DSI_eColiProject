...
traindata_numeric <- traindata %>%
  select(c("StandardizedResult", "Discharge_CFS", "USGS_Staff", "Precipitation..in.", "Tmax..F.", "Tmin..F.", "Previous3Precip", "Previous7Precip", "Previous30Precip", "NinXTS", "TOD", "Stage", "SeasonNumeric", "ACO_Numeric", "DistFromSonoita"))
...
```{r}
cor2 <- cor(traindata %>%
  select(c("StandardizedResult", "Previous30Precip", "Tmin..F.", "Discharge_CFS", "Stage","NinXTS", "TOD","ACO_Numeric", "DistFromSonoita")))
