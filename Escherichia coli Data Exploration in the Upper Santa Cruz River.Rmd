...
#LAURA This may need more exploration. I want to categorically attribute a rising or falling stage to this data. Normal flow in this river has a diurnal cycle, so the max and min flows occur around noon and midnight. 
...
```{r}
# Take the difference between the two columns and attribute to the second column.
USGS_Standardized <- USGS_Standardized %>% 
...
# Now I can summarize the differences and easily alter to what I want using the binary variable. This will create another binary variable where 1 = rise and 0 = fall.
# 96 is one day of readings (24 hours x quarterly readings)
