...
# Remove the old data
remove(USGS_Standardized_Fill,USGS_Raw)
...
write.csv(data_Merge3 %>%
            select("Previous30Precip", "Tmin..F.", "Discharge_CFS", "Stage","NinXTS", "TOD","ACO_Numeric", "DistFromSonoita","ecoli_235", "ecoli_575" ), "Data/Processed/ecoli_attributed.csv")
```
