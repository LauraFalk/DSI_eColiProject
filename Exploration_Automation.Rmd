...
# ensure that date field is *actually* a date field. 
PrecipRaw$dateFormatted <- lubridate::mdy(PrecipRaw$date)


PrecipRaw %>%
  filter(dateFormatted >= startDate & dateFormatted <= endDate) %>%
  summarise(Previous30Precip = sum(prcp_in))
```
>>>>>>> dc4a5a9d8d115615e3ddbe42838671efde91fbcc
# Discharge data
...
=======
Discharge_CFS <- tail(USGSRaw$X_00060_00000, n=1)
>>>>>>> dc4a5a9d8d115615e3ddbe42838671efde91fbcc
```
