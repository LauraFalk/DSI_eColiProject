...
Now to handle the ones that didn't merge.
```{r}
...
Lets look at what the data currently looks like. The blue dotted line indicates the standard for average measurements. It is not technically applicable here, but gives a baseline. The red line is the actual standard for warm water effluent in AZ. 
```{r}
